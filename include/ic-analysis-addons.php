...
if( !class_exists( 'ic-analysis-addon' ) ) {
	class ic_analysis_addon{
		
		function __construct() {			
			 add_action( 'admin_menu', array( $this, 'addon_page' ) );
		...
		function addon_page(){
			add_submenu_page( 'sales-analysis', 'Other Plug-ins', 'Other Plug-ins', 'manage_options', 'ic-analysis-addon', array( $this, 'addons_page' ) );
		}
				...
				<div class="ic_plugins_container">
					<div class="row">
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/golden_report.jpg" alt="WooCommerce Advance Sales Report (Gold Version)" />
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/premium-gold-report.jpg" alt="WooCommerce Advance Sales Report (Premium Gold Version)">
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/enterprise_edition.jpg" alt="WooCommerce Advance Sales Report (Enterprise Edition)" />
								</div>
								<div class="ic_plugin_content">
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/inventory.jpg" alt="WooCommerce Inventory Plugin" />
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/job-manager.jpg" alt="WooCommerce Job Manager" />
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/subscription.jpg" alt="WooCommerce Subscription" />
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/sales_trends_analysis.jpg" alt="WooCommerce Sales Trends Analysis" />
								</div>
						...
						<div class="col-md-4">
							<div class="ic_other_plugins">
								<div class="ic_plugin_img">
									<img src="<?php echo $this->constants['plugin_url']?>/images/icons/audit-log-pro.jpg" alt="WooCommerce Audit Log Pro" />
								</div>
